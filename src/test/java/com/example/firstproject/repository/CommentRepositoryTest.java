...
class CommentRepositoryTest {
    ...
    void findByArticleId() {
        ...
        //Case 3 : 9번 게시글의 모든 댓글 조회
        {
            ...
            List<Comment> expected = Arrays.asList();
            //4. 비교 및 검증
            assertEquals(expected.toString(),comments.toString(),"9번 게시글은 없다.");
        }
        ...
        //Case 4 : 999번 게시글의 모든 댓글 조회
        {
            ...
            List<Comment> expected = Arrays.asList();
            //4. 비교 및 검증
            assertEquals(expected.toString(),comments.toString(),"999번 게시글은 없다.");
        }
        ...
        //Case 5 : -1번 게시글의 모든 댓글 조회
        {
            ...
            List<Comment> expected = Arrays.asList();
            //4. 비교 및 검증
            assertEquals(expected.toString(),comments.toString(),"-1번 게시글은 있을 수 없다.");
        }
    ...
    void findByNickname() {
        ...
        //Case 5: null의 모든 댓글 조회
        {
            ...
            List<Comment> expected = Arrays.asList();
            //4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "null은 데이터가 없다.");
        }
        ...
        //Case 6: ""의 모든 댓글 조회
        {
            ...
            List<Comment> expected = Arrays.asList();
            //4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "\"\"의 댓글은 없다.");
        }
    }
